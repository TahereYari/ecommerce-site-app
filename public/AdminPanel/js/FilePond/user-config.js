   //***********************************UploadImage*****************************************
function initializeImageUser(uploadUrl, deleteUrl) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    const pond = initializeImageUser('/admin/upload-image-user', '/admin/delete-image-user');
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            if (userImage) {
                pond.removeFiles();
                pond.addFile(baseUrl + 'Images/User/' + userImage, {
                    type: 'local', // Indicate it's a preloaded file
                    source: baseUrl + 'Images/User/' + userImage,
                    options: {
                        type: 'local'
                    }
                });
